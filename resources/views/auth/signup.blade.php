...
<div class="register-box">
  ...
  <h3 class="login-box-msg font-weight-bold">{{__('Sign Up')}}</h3>
  ...
  <form action="{{ route('register') }}" method="post">
    ...
    <div class="row">
      <div class="col-12">
        <div class="icheck-primary">
          ...
          <label for="agreeTerms">
            {{__('I agree to the')}} <a href="{{ route('term') }}">{{__('terms')}}</a>
          </label>
        </div>
      ...
      <div class="col-12">
        <button type="submit" class="btn btn-primary btn-block font-weight-bold">{{__('Sign Up')}}</button>
      </div>
      <!-- /.col -->
    </div>
  </form>
  ...
  <p class="mb-0">
    <a href="{{ route('login') }}" class="font-weight-bold">{{__('I already have a membership')}}</a>
  </p>
