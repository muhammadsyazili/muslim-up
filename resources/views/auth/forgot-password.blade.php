...
<div class="login-box">
  ...
  <h3 class="login-box-msg font-weight-bold">{{__('Forgot Password')}}</h3>
  ...
  <form action="{{ route('password.email') }}" method="post">
    ...
    <div class="row">
      <div class="col-12">
        <button type="submit" class="btn btn-primary btn-block font-weight-bold">{{__('Request new password')}}</button>
      </div>
      <!-- /.col -->
    </div>
  </form>
